...
(function($) {
    ...
    function createTableFooterPagination(idTable, nTdsColspan, last) {
        var pagination = "<span><button class='btn btn-dark btn-sm paginationInit'><i class='fas fa-chevron-left'></i></button></span> ";
        for (var i = 1; i <= last; i++) {
            pagination += "<span><button class='btn btn-dark btn-sm paginationClick'>" + i + "</button></span> ";
        }
        pagination += "<span><button class='btn btn-dark btn-sm paginationEnd'><i class='fas fa-chevron-right'></i></button></span>"
        tfoot = "<tfoot class='text-left'><tr><td colspan='" + nTdsColspan + "'>" + pagination + "</td></tr></tfoot>";
